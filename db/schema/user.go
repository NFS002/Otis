...
// UserSchema : DynamoDB loose (NoSQL) schema for the user table
var UserSchema *dynamodb.CreateTableInput = &dynamodb.CreateTableInput{
	...
	AttributeDefinitions: []*dynamodb.AttributeDefinition{
		...
		{
			AttributeName: aws.String("univerity"),
			AttributeType: aws.String("S"),
		},
	},
	...
	KeySchema: []*dynamodb.KeySchemaElement{
		...
		{
			AttributeName: aws.String("university"),
