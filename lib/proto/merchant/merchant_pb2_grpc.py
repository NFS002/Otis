...
from lib.proto.merchant import merchant_pb2 as lib_dot_proto_dot_merchant_dot_merchant__pb2
...
class MerchantServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateGeneralMerchant = channel.unary_unary(
                ...
                request_serializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantRequest.SerializeToString,
                response_deserializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.FromString,
                )
        ...
        self.GetGeneralMerchant = channel.unary_unary(
                ...
                request_serializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantQuery.SerializeToString,
                response_deserializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.FromString,
                )
...
def add_MerchantServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateGeneralMerchant': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantRequest.FromString,
                    response_serializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.SerializeToString,
            ),
            ...
            'GetGeneralMerchant': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantQuery.FromString,
                    response_serializer=lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.SerializeToString,
            ),
...
class MerchantService(object):
    ...
    def CreateGeneralMerchant(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/merchant.MerchantService/CreateGeneralMerchant',
            lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantRequest.SerializeToString,
            lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.FromString,
    ...
    def GetGeneralMerchant(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/merchant.MerchantService/GetGeneralMerchant',
            lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantQuery.SerializeToString,
            lib_dot_proto_dot_merchant_dot_merchant__pb2.MerchantsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
